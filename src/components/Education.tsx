      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center gap-8">
            ...
            {/* Timeline Element */}
            <motion.div
              className="relative pl-8 md:pl-12 border-l-2 border-brand-red py-4 flex flex-col gap-6"
            ...
            >
              ...
              <div className="absolute -left-[9px] top-5 w-4 h-4 rounded-full bg-brand-red border-4 border-bg-solid ring-4 ring-brand-red-glow" />
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-sans text-sm md:text-base font-semibold text-brand-red">
                    Computer Science and Engineering
                  </span>
                </div>
                {/* Year Label Tag */}
                <div className="flex items-center gap-1.5 px-3 py-1 bg-brand-red-glow border border-brand-border-glow text-brand-red text-xs font-mono w-fit font-bold">
                  <Calendar size={12} />
                  <span>2024 — 2028</span>
                </div>
              </div>
              ...
              {/* Description */}
              <p className="font-sans text-sm md:text-base leading-relaxed text-text-gray mt-2">
          ...
          >
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 w-64 h-64 rounded-full bg-brand-red select-none z-0 pointer-events-none" />
            ...
            <div className="w-full max-w-[360px] h-[480px] border border-brand-border grayscale contrast-[1.1] hover:grayscale-0 transition-all duration-[1.2s] relative z-10 shadow-2xl overflow-hidden bg-bg-charcoal">
              ...
              <div className="absolute top-4 right-4 bg-brand-red/90 px-3 py-1 font-mono text-[9px] text-white tracking-widest z-20">
