...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-bg-solid border-t border-brand-border py-12 overflow-hidden z-20">
      ...
      <div className="w-full py-4 md:py-6 overflow-hidden flex whitespace-nowrap mb-12 select-none pointer-events-none" style={{ background: 'linear-gradient(90deg, #1d4ed8, #2563EB, #3B82F6, #2563EB, #1d4ed8)', boxShadow: '0 0 24px rgba(59,130,246,0.3)' }}>
        <motion.div
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-3 flex justify-start md:justify-end items-center">
            <button
              onClick={scrollToTop}
              className="p-4 rounded-none border border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white transition-all duration-300 flex items-center gap-2 font-manrope text-[10px] tracking-widest uppercase font-semibold blue-glow"
        ...
        <div className="border-t border-brand-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-mono tracking-widest text-text-muted">
          ...
          <div className="flex items-center gap-1">
            ...
            <Heart size={10} className="text-electric-blue fill-electric-blue animate-pulse" />
