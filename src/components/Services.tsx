  ...
  const services = [
    {
      ...
      icon: <Layers className="text-brand-blue" size={22} />,
    },
    {
      id: "02",
      ...
      icon: <Layout className="text-brand-blue" size={22} />,
    },
    {
      id: "03",
    ...
    },
    {
      ...
      icon: <Code className="text-brand-blue" size={22} />,
    },
    {
      id: "06",
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* Services Grid — auto height, no fixed h */}
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-center mb-5">
                  ...
                  <span className="font-bebas text-2xl sm:text-3xl font-bold text-outline-blue">
                    {service.id}
                  </span>
                </div>
